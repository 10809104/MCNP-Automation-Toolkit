...
> **提示**: 你可以跳過此步驟，直接從 [Releases](https://github.com/yourusername/MCNP-Automation-Toolkit/releases) 頁面下載 `MCNP_Parser.exe`。
...
當所有模擬完成後，系統將自動詢問是否啟動 **Data Parser** 來生成報表。
...
本專案採用 MIT 授權條款 – 詳見 [LICENSE](https://www.google.com/search?q=LICENSE) 檔案。
